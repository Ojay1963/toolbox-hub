...
const toolDraftsPart1: ToolDraft[] = [
  ...
  makeTool({ name: "Blur Image Tool", slug: "blur-image-tool", category: "image-tools", shortDescription: "Blur part of an image or soften the full picture before saving a cleaner copy.", longDescription: "Blur Image Tool helps when an image shows more detail than you want to share. You can soften faces, names, license plates, messy backgrounds, or screenshot sections before posting, sending, or saving the image. It is also useful for quick design effects when you want text or a subject to stand out against a softer background. For example, a freelancer may blur client details in a screenshot before publishing a case study, while a seller may soften a busy background so the main product stands out more clearly. It is a practical free image tool because it solves privacy and presentation problems without needing paid editing software.", keywords: ["blur image", "blur photo online", "blur screenshot", "hide details in image", "soften image"], howToUse: ["Upload the image you want to edit, such as a screenshot, document image, or photo with distracting details.", "Choose the blur strength or blur area and preview the softened result before saving it.", "Download the blurred image, then continue to Crop Image or Image Compressor if you want a tighter or lighter final version."], implementationStatus: "working-local", seoTitle: "Free Image Blur Tool — Blur Photos & Screenshots Fast", seoDescription: "Blur any image to hide sensitive information or soften backgrounds — free. Upload, adjust blur strength, and download in seconds.", faq1: "What is a practical reason to blur an image?", faqAnswer1: "A practical reason is hiding private details such as names, account information, addresses, or license plates while keeping the rest of the image usable.", faq2: "Should I blur or crop a screenshot?", faqAnswer2: "Blur works best when you still need the full screenshot but want to hide one part of it. Crop is better when the extra area can be removed completely." }),
  makeTool({ name: "Image Format Converter", slug: "image-format-converter", category: "image-tools", shortDescription: "Convert images between popular formats in one free browser-side workflow.", longDescription: "Image Format Converter is a practical all-in-one tool when you know the image works visually but the current file type does not fit the task. It helps when you need to switch between JPG, PNG, and WebP without jumping through multiple one-off converters. A blogger might change a screenshot to PNG for editing, then export a final WebP for publishing, while a store owner might turn a large PNG into JPG for faster uploads. It is especially appealing because it covers several common conversions at once and keeps the full workflow free in the browser.", keywords: ["image format converter", "convert image format", "jpg png webp converter", "image file type converter"], howToUse: ["Upload the image you want to convert, such as a photo, logo, screenshot, or exported design file.", "Choose the output format that fits your workflow, such as JPG, PNG, or WebP.", "Download the converted image, then use Image Compressor or Image Resizer if you also need a lighter or smaller version."], implementationStatus: "working-local", seoTitle: "Image Format Converter Online", seoDescription: "Convert image formats online between JPG, PNG, and WebP with a free browser-side workflow and simple download-ready output.", faq1: "When is an image format converter better than a one-way converter?", faqAnswer1: "It is better when you want one tool that can handle several common format changes without opening separate converter pages for each direction.", faq2: "Will changing format automatically improve image quality?", faqAnswer2: "Not always. The main benefit is making the image fit the workflow or platform you need. Quality and file size still depend on the source image and chosen format." }),
  makeTool({ name: "Image Color Picker", slug: "image-color-picker", category: "image-tools", shortDescription: "Pick exact colors from an uploaded image and copy the values for design work.", longDescription: "Image Color Picker is useful when you want to pull a real color from a photo, logo, screenshot, packaging image, or design reference instead of guessing by eye. This is especially helpful for branding work, social graphics, website accents, moodboards, and visual matching tasks. For example, a designer might sample a button color from a screenshot, or a shop owner might grab a product shade from a photo before building a matching promo graphic. It is an appealing tool because the result is instantly reusable in design and front-end work, and it stays free by processing in the browser.", keywords: ["image color picker", "pick color from image", "extract color from photo", "image hex picker"], howToUse: ["Upload the image that contains the color you want to sample, such as a logo, screenshot, or product photo.", "Click or inspect the area you want to sample and review the returned color value.", "Copy the result for your design, code, or branding workflow, then use Color Contrast Checker if you want to test readability next."], implementationStatus: "working-local", seoTitle: "Image Color Picker Online", seoDescription: "Pick colors from images online and copy HEX or related values for design, branding, and front-end workflows.", faq1: "What is a common use case for an image color picker?", faqAnswer1: "A common use case is sampling a brand, product, or interface color from a screenshot or photo so you can reuse it consistently elsewhere.", faq2: "Is this useful for web design as well as graphics?", faqAnswer2: "Yes. Designers and developers often use picked color values in CSS, design systems, marketing graphics, and visual brand guides." }),
  makeTool({ name: "Image Color Palette Generator", slug: "image-color-palette-generator", category: "image-tools", shortDescription: "Generate a color palette from an uploaded image for branding, content, and design work.", longDescription: "Image Color Palette Generator is useful when one image already captures the mood you want and you need a matching set of colors from it. This is popular for branding, social posts, pitch decks, moodboards, product launches, and quick design planning. For example, a creator may upload a hero photo and pull several colors for matching cards and buttons, or a seller may extract colors from a product image before designing a banner around it. It is especially appealing because it turns one visual reference into a reusable design direction without paid software.", keywords: ["image color palette generator", "extract palette from image", "photo palette generator", "image palette tool"], howToUse: ["Upload the image you want to sample, such as a hero photo, logo, or product image.", "Generate the palette and review the extracted colors to find the tones you want to reuse.", "Copy or note the palette values for your design work, and use Image Color Picker if you need one exact sample from a specific area."], implementationStatus: "working-local", seoTitle: "Image Color Palette Generator Online", seoDescription: "Extract a reusable color palette from an image online with a free browser-side workflow for branding and design inspiration.", faq1: "Why use a palette generator instead of picking one color by hand?", faqAnswer1: "A palette generator is useful when you need several related colors that work together, not just one sampled color from a single point.", faq2: "What kinds of images produce interesting palettes?", faqAnswer2: "Photos with clear lighting, strong subject colors, or a distinctive visual mood usually produce the most useful and memorable palettes." }),
  makeTool({ name: "Image Brightness Adjuster", slug: "image-brightness-adjuster", category: "image-tools", shortDescription: "Brighten dark images or lower brightness before saving a corrected copy.", longDescription: "Image Brightness Adjuster helps when a photo, screenshot, or exported graphic looks too dark or too washed out for its final use. It is useful for product shots, social images, blog illustrations, screenshots, and presentation graphics that need a quick lift before sharing. For example, a seller may brighten a product photo taken in weak indoor light, or a writer may lower the brightness of a screenshot before adding text over it. This is an appealing free tool because it solves a common photo problem with a simple browser-side workflow instead of requiring a heavier editor.", keywords: ["image brightness adjuster", "brighten image", "darken photo", "adjust image brightness"], howToUse: ["Upload the image you want to adjust, such as a product photo, social graphic, or screenshot.", "Move the brightness setting until the picture looks more balanced and easier to read.", "Download the edited image, then use Image Contrast Adjuster or Image Compressor if you want a more polished final result."], implementationStatus: "working-local", seoTitle: "Image Brightness Adjuster Online", seoDescription: "Adjust image brightness online to brighten dark photos or reduce glare before downloading a corrected copy.", faq1: "When should I adjust brightness instead of contrast?", faqAnswer1: "Brightness is best when the whole image feels too dark or too light overall. Contrast is more useful when the light and dark areas need stronger separation.", faq2: "Can brightening an image fix every low-light photo?", faqAnswer2: "Not always. It can improve readability and visibility, but very dark or noisy images may still need more editing afterward." }),
  makeTool({ name: "Image Contrast Adjuster", slug: "image-contrast-adjuster", category: "image-tools", shortDescription: "Increase or soften contrast to make photos and graphics clearer before download.", longDescription: "Image Contrast Adjuster is useful when the image technically looks fine but still feels flat, muddy, or too harsh. It helps add separation between light and dark areas so screenshots, photos, product images, and graphics become easier to read and more visually balanced. For example, a blog publisher may increase contrast on a faded screenshot, or a shop owner may soften contrast on a harsh product image taken under direct light. This is an appealing image tool because a small contrast change can make a big difference without asking the user to learn advanced editing steps.", keywords: ["image contrast adjuster", "adjust image contrast", "increase photo contrast", "reduce contrast image"], howToUse: ["Upload the image you want to improve, such as a photo, screenshot, or marketing graphic.", "Adjust the contrast until the image feels clearer, smoother, or easier to read.", "Download the updated image and continue to Image Brightness Adjuster or Image Compressor if you want to refine it further."], implementationStatus: "working-local", seoTitle: "Image Contrast Adjuster Online", seoDescription: "Adjust image contrast online to make photos, screenshots, and graphics clearer before downloading the edited result.", faq1: "What is a simple use case for contrast adjustment?", faqAnswer1: "A simple use case is making a flat screenshot or faded photo easier to read by increasing the difference between lighter and darker areas.", faq2: "Can too much contrast make an image worse?", faqAnswer2: "Yes. Heavy contrast can hide detail in shadows or highlights, so it helps to preview the result and stop when the image still looks natural enough for the task." }),
  makeTool({ name: "Image Grayscale Converter", slug: "image-grayscale-converter", category: "image-tools", shortDescription: "Convert full-color images into grayscale for print, style, or simple analysis.", longDescription: "Image Grayscale Converter is useful when you want a black-and-white version of an image for printing, a cleaner visual style, or quick comparison without color distractions. This can help with posters, worksheets, moodboards, profile graphics, screenshot cleanup, and design experiments where color is not the focus. For example, a teacher may turn a handout image grayscale before printing, or a creator may test whether a composition still works without relying on color. It is an appealing free tool because it gives a clear stylistic change instantly without sending the image to a paid service.", keywords: ["image grayscale converter", "convert image to grayscale", "black and white image tool", "remove color from image"], howToUse: ["Upload the image you want to convert, such as a photo, poster graphic, or screenshot.", "Run the grayscale conversion and compare the color-free result with the original version.", "Download the final image, then use Image Contrast Adjuster if you want stronger separation in the black-and-white result."], implementationStatus: "working-local", seoTitle: "Image Grayscale Converter Online", seoDescription: "Convert images to grayscale online with a free browser-side workflow for print, style, and quick editing needs.", faq1: "Why would I convert an image to grayscale?", faqAnswer1: "People convert images to grayscale for printing, cleaner layouts, black-and-white styling, or to check whether the composition still works without color.", faq2: "Is grayscale the same as simply lowering saturation?", faqAnswer2: "Not exactly. Both remove color influence, but a proper grayscale conversion is meant to create a full black-and-white result rather than just a muted color image." }),
  makeTool({ name: "EXIF Data Remover", slug: "exif-data-remover", category: "image-tools", shortDescription: "Remove embedded photo metadata before sharing images more publicly.", longDescription: "EXIF Data Remover is useful when you want to share a photo but keep extra embedded metadata out of the exported file. That metadata can include camera details, timestamps, orientation data, and in some cases location-related information depending on the original image. This is especially appealing for privacy-conscious sharing, marketplace uploads, client delivery, and cleaner publishing workflows. For example, a photographer may remove metadata from a preview before public posting, or a user may clean a phone image before attaching it to a listing or form. The tool stays free because it can strip the embedded data locally in the browser.", keywords: ["exif data remover", "remove image metadata", "strip exif data", "photo metadata remover"], howToUse: ["Upload the photo you want to clean before sharing, such as a phone image, camera photo, or exported file.", "Run the metadata removal step and review the cleaned version prepared for download.", "Download the cleaned image, then use Image Metadata Viewer first if you want to inspect the original embedded details before removing them."], implementationStatus: "working-local", seoTitle: "EXIF Data Remover Online", seoDescription: "Remove EXIF and embedded image metadata online with a free browser-side workflow for cleaner and more private image sharing.", faq1: "Why remove EXIF data from an image?", faqAnswer1: "People remove EXIF data to reduce unwanted metadata exposure before sharing a photo publicly, sending it to clients, or uploading it to a listing or form.", faq2: "Will removing EXIF data change the visible picture?", faqAnswer2: "The main goal is to clean metadata, not to change the visible image. The photo should still look the same for normal viewing in most workflows." }),
  makeTool({ name: "EXIF Data Viewer", slug: "exif-data-viewer", category: "image-tools", shortDescription: "Inspect embedded EXIF photo metadata before you share, edit, or archive an image.", longDescription: "EXIF Data Viewer is useful when you want to see what metadata is stored inside a photo before you publish it, send it to someone else, or clean it up. That can include camera make and model, orientation, timestamps, and other embedded details depending on the original image. A photographer might check what information a file still carries before posting a preview online, while a seller may inspect a phone photo before uploading it to a marketplace. It is a practical free tool because it helps people understand what is inside the file before deciding whether to keep it, remove it, or export a cleaner copy.", keywords: ["exif data viewer", "view photo metadata", "image exif viewer", "check image metadata"], howToUse: ["Upload the image you want to inspect, especially if it came from a phone or camera.", "Review the embedded EXIF details shown by the tool so you understand what metadata is present.", "Keep the image as it is or switch to EXIF Data Remover if you want to export a cleaner version for sharing."], implementationStatus: "working-local", seoTitle: "EXIF Data Viewer Online", seoDescription: "View EXIF photo metadata online with a free browser-side workflow before sharing, cleaning, or archiving an image.", faq1: "Why would I inspect EXIF data before sharing a photo?", faqAnswer1: "It helps you understand whether the file still contains details you may not want to publish openly, such as capture information or other embedded metadata.", faq2: "Does every image include EXIF data?", faqAnswer2: "No. Some images include little or no EXIF data, especially after export or editing, while others from cameras and phones may carry more embedded details." }),
  makeTool({ name: "Image Metadata Viewer", slug: "image-metadata-viewer", category: "image-tools", shortDescription: "Check basic image file details such as dimensions, type, size, and embedded density data.", longDescription: "Image Metadata Viewer is useful when you want a quick technical summary of an image before printing it, uploading it, or preparing it for another workflow. It can help you confirm width, height, file type, file size, and related image details without opening a full editing app. For example, a designer may check whether an exported asset is the right size for a landing page, or a seller may inspect a product image before uploading it to a store. This is a practical free tool because it answers common file questions instantly in the browser.", keywords: ["image metadata viewer", "check image details", "image file info", "image dimensions viewer"], howToUse: ["Upload the image you want to inspect, such as a product photo, website asset, or print image.", "Review the reported dimensions, file type, and other file details shown by the tool.", "Use the information to decide whether you should resize, compress, convert, or keep the image as it is."], implementationStatus: "working-local", seoTitle: "Image Metadata Viewer Online", seoDescription: "View image dimensions, type, file size, and other metadata online with a free browser-side inspection tool.", faq1: "When is an image metadata viewer useful?", faqAnswer1: "It is useful when you need to confirm image size, type, or basic technical details before printing, uploading, converting, or sharing the file.", faq2: "Is this different from EXIF viewing?", faqAnswer2: "Yes. Basic metadata viewing focuses on core file details such as size and dimensions, while EXIF viewing is more about embedded camera-style photo metadata." }),
  makeTool({ name: "Image DPI Checker", slug: "image-dpi-checker", category: "image-tools", shortDescription: "Check image DPI and dimensions before print or export decisions.", longDescription: "Image DPI Checker is useful when you need to know whether an image is likely to suit a print-related workflow instead of just a screen-based one. It helps you inspect embedded density information alongside image dimensions before you print flyers, posters, cards, labels, or document graphics. For example, a designer may check whether an image is ready for a print proof, or a small business owner may inspect a logo file before sending it to a printer. It is an appealing free tool because people often need this answer quickly but do not want to open a heavy editing app just to inspect DPI data.", keywords: ["image dpi checker", "check image dpi", "photo dpi checker", "print image dpi"], howToUse: ["Upload the image you want to inspect before printing or exporting it further.", "Review the DPI and dimension details shown by the tool to see whether the file fits your planned use.", "Resize or replace the image if needed, especially if the final print size requires more detail than the current file can support."], implementationStatus: "working-local", seoTitle: "Image DPI Checker Online", seoDescription: "Check image DPI and dimensions online with a free browser-side tool for print and export preparation.", faq1: "Why does DPI matter for some images?", faqAnswer1: "DPI matters most when the image is being prepared for print, because it affects how detailed the image may appear at a chosen physical size.", faq2: "Does a higher DPI always mean a better image?", faqAnswer2: "Not by itself. The actual pixel dimensions still matter, so DPI is most useful when considered together with width, height, and intended print size." }),
  makeTool({ name: "Image Border Generator", slug: "image-border-generator", category: "image-tools", shortDescription: "Add a border around an image to create cleaner product, profile, and social graphics.", longDescription: "Image Border Generator helps when a photo or graphic feels unfinished against a plain background. Adding a simple border can make product images, quote cards, profile pictures, thumbnails, and printables look more intentional without opening a full design app. For example, a store owner may add a clean frame to a product photo, while a creator may give a profile or quote image a more polished finish before posting it. It is an appealing free tool because a small border change can make simple images feel much more presentable.", keywords: ["image border generator", "add border to image", "photo border tool", "frame image online"], howToUse: ["Upload the image you want to frame, such as a profile picture, product photo, or social graphic.", "Choose the border size and look, then preview the result before exporting it.", "Download the updated image and continue to Image Resizer if you need it in a specific final size."], implementationStatus: "working-local", seoTitle: "Image Border Generator Online", seoDescription: "Add borders to images online with a free browser-side tool for product images, profile graphics, and social visuals.", faq1: "When does a border improve an image?", faqAnswer1: "A border can help when the image blends into the page background or needs a stronger frame for sharing, printing, or presentation slides.", faq2: "Can a border change the final image size?", faqAnswer2: "Yes. Adding a border can increase the overall dimensions unless the border is drawn inward, so it is worth checking final size requirements before export." }),
  makeTool({ name: "Image Color Inverter", slug: "image-color-inverter", category: "image-tools", shortDescription: "Invert image colors for quick design effects, alternate views, or playful edits.", longDescription: "Image Color Inverter is useful when you want a fast negative-style version of an image for creative work, experiments, comparison, or visual effects. It can help with posters, art references, social graphics, and quick style tests where you want a very different look without editing the image manually. For example, a creator may invert a simple design for a striking post variation, or a designer may compare an alternate treatment before choosing a final direction. It is an appealing free tool because it gives a dramatic visual change instantly in the browser.", keywords: ["image color inverter", "invert image colors", "negative image tool", "photo color inverter"], howToUse: ["Upload the image you want to transform, such as a graphic, screenshot, or photo.", "Run the color inversion step and compare the alternate look with the original image.", "Download the inverted version if it fits your design, or switch to Blur Image Tool or Grayscale Converter for a different effect."], implementationStatus: "working-local", seoTitle: "Image Color Inverter Online", seoDescription: "Invert image colors online with a free browser-side tool for quick visual effects and alternate design treatments.", faq1: "Why would someone invert image colors?", faqAnswer1: "People invert colors for creative effects, design testing, dramatic alternate looks, or simply to experiment with how an image feels in reverse tones.", faq2: "Is color inversion the same as grayscale?", faqAnswer2: "No. Grayscale removes color influence, while inversion flips the color values to create a much more dramatic alternate image." }),
  makeTool({ name: "Image Noise Reducer", slug: "image-noise-reducer", category: "image-tools", shortDescription: "Soften visible image noise for cleaner-looking photos and exported graphics.", longDescription: "Image Noise Reducer is useful when an image looks rough, grainy, or a little too messy after capture, screenshotting, or export. It can help with low-light phone photos, rough screenshots, simple graphics, and quick cleanup tasks where you want a smoother result before sharing. For example, a seller may soften a noisy product photo taken in weak lighting, or a creator may reduce grain in an uploaded image before using it in a post. It is an appealing free image tool because it handles a real quality problem without asking the user to learn a full editor.", keywords: ["image noise reducer", "reduce image noise", "denoise photo online", "smooth grainy image"], howToUse: ["Upload the image you want to clean up, such as a low-light photo or rough screenshot.", "Apply the noise reduction step and compare the smoother output with the original image.", "Download the result, then use Image Contrast Adjuster or Image Compressor if you want to fine-tune the final version."], implementationStatus: "working-local", seoTitle: "Image Noise Reducer Online", seoDescription: "Reduce image noise online with a free browser-side tool for smoother-looking photos, screenshots, and exported graphics.", faq1: "What kind of image usually benefits from noise reduction?", faqAnswer1: "Low-light photos and rough-looking screenshots are common examples, especially when the image feels grainy or messy before sharing.", faq2: "Can too much noise reduction make an image look soft?", faqAnswer2: "Yes. Heavy smoothing can reduce detail, so it helps to preview the result and stop when the image looks cleaner without feeling overly blurred." }),
  makeTool({ name: "Image Histogram Analyzer", slug: "image-histogram-analyzer", category: "image-tools", shortDescription: "Analyze image tone distribution with a histogram before editing or exporting.", longDescription: "Image Histogram Analyzer is useful when you want a more technical view of how an image is balanced before editing it further. It helps reveal whether an image is heavily dark, strongly bright, or more evenly spread across tones, which can guide brightness and contrast decisions. For example, a creator may inspect a moody photo before brightening it, or a designer may analyze a graphic before changing contrast for print or web use. It is a valuable free tool for users who want more than just visual guesswork when adjusting an image.", keywords: ["image histogram analyzer", "photo histogram tool", "analyze image tones", "image tone distribution"], howToUse: ["Upload the image you want to inspect before making edits or export choices.", "Review the histogram to see how tones are distributed across the image.", "Use that information to decide whether brightness, contrast, or another image adjustment is worth doing next."], implementationStatus: "working-local", seoTitle: "Image Histogram Analyzer Online", seoDescription: "Analyze image tone distribution online with a free browser-side histogram tool for more informed editing decisions.", faq1: "Why would I look at a histogram instead of just the image preview?", faqAnswer1: "A histogram can show tone distribution more clearly than your eyes alone, especially when an image looks close to balanced but still feels slightly too dark or bright.", faq2: "Is a histogram only for photographers?", faqAnswer2: "No. It can also help designers, marketers, and anyone who wants a more technical read on an image before adjusting it." }),
  makeTool({ name: "GIF Maker", slug: "gif-maker", category: "image-tools", shortDescription: "Turn a sequence of images into a shareable GIF animation for free in the browser.", longDescription: "GIF Maker is useful when several images tell a short story better than one still frame. You can turn screenshots, product steps, design progress shots, or simple photo sequences into a looping GIF for messages, tutorials, or social posts. For example, a creator may combine a few progress images into a quick animation, or a seller may show a product from several angles in one looping file. It is an especially appealing free tool because it creates an eye-catching visual format without paid editing software or a video workflow.", keywords: ["gif maker", "make gif from images", "image to gif", "animated gif creator"], howToUse: ["Upload the images you want to animate, such as screenshots, product angles, or step-by-step visuals.", "Choose the frame order and timing so the GIF moves the way you want.", "Export the finished GIF and use it in chats, posts, guides, or simple promotional content."], implementationStatus: "working-local", seoTitle: "Free GIF Maker — Create Animated GIFs Online Instantly", seoDescription: "Create animated GIFs from photos or frames online — free. Upload images, set speed and loop, then download your GIF in seconds.", faq1: "What kinds of images make a smoother GIF?", faqAnswer1: "Images with similar size, framing, and lighting usually create the smoothest animations, because large jumps between frames can feel abrupt.", faq2: "Should I resize images before making a GIF?", faqAnswer2: "Usually yes. Smaller images often create lighter GIF files that are easier to share on websites, chats, and social platforms." }),
  makeTool({ name: "Video to GIF Converter", slug: "video-to-gif-converter", category: "image-tools", shortDescription: "Convert a short video clip into a GIF for tutorials, previews, and social content.", longDescription: "Video to GIF Converter is useful when a short moment from a video would work better as a looping animation than as a full video file. It helps with product previews, tutorials, app demos, reaction clips, and simple social content that needs to load quickly and replay automatically. For example, a developer may turn a UI demo into a GIF for a changelog, or a seller may create a short product-motion preview for a listing. It is an appealing free tool because it turns an existing clip into a more shareable format directly in the browser.", keywords: ["video to gif converter", "convert video to gif", "make gif from video", "mp4 to gif"], howToUse: ["Upload the short video clip you want to turn into a looping animation.", "Set the section, timing, or output choices used to create the GIF.", "Download the GIF and use it in guides, posts, previews, or simple promotional content."], implementationStatus: "working-local", seoTitle: "Video to GIF Converter Online", seoDescription: "Convert short videos to GIF online with a free browser-side workflow for tutorials, previews, and social sharing.", faq1: "When is a GIF better than a video clip?", faqAnswer1: "A GIF can be better when you want a short loop that plays quickly without asking the viewer to manage a full video file.", faq2: "Should I use a shorter clip for a GIF?", faqAnswer2: "Yes. Shorter clips usually create smaller, smoother GIFs that are easier to share and load." }),
  makeTool({ name: "Video Frame Extractor", slug: "video-frame-extractor", category: "image-tools", shortDescription: "Capture a still image from a video at the exact moment you want.", longDescription: "Video Frame Extractor is useful when one moment from a video deserves to become a standalone image. This can help with thumbnails, blog illustrations, presentation slides, product previews, and social posts where a still frame is more practical than the full clip. For example, a creator may pull one clean frame from a demo video for a thumbnail, or a seller may capture a specific product angle from a short spin clip. It is a practical free tool because it gives you a usable still image without requiring paid video editing software.", keywords: ["video frame extractor", "extract frame from video", "capture still from video", "video screenshot tool"], howToUse: ["Upload the video file you want to sample, such as a product clip, tutorial, or screen recording.", "Choose the exact moment you want to capture and preview the extracted frame.", "Download the still image and continue to Image Resizer or Image Compressor if you need it optimized for a specific use."], implementationStatus: "working-local", seoTitle: "Video Frame Extractor Online", seoDescription: "Extract still frames from videos online with a free browser-side workflow for thumbnails, previews, and visual content reuse.", faq1: "What is a common use case for video frame extraction?", faqAnswer1: "A common use case is capturing a thumbnail, product moment, or tutorial frame that is easier to reuse as an image than as part of a full video clip.", faq2: "Can I use this instead of taking a random screenshot?", faqAnswer2: "Yes. It is more precise because you can choose the exact point in the video instead of relying on a rough manual screenshot." }),
  makeTool({ name: "PDF Merge", slug: "pdf-merge", category: "pdf-tools", shortDescription: "Merge multiple PDF files into one document in the order you choose.", longDescription: "PDF Merge is useful when several separate files need to become one clean document. That might mean joining invoices into one monthly record, combining class notes into a single study file, or putting a cover page in front of a report before sharing it. Instead of sending multiple attachments, you can upload the PDFs, place them in the right order, and download one finished file. For example, a job seeker might combine a cover sheet, resume, and certificates into one PDF, while a small business owner might merge several scans into one client packet. Keeping everything together also makes printing and archiving easier. If you only need part of a document before merging, PDF Split can help first, and PDF Compressor is useful when the final merged file needs to be lighter for email or upload limits.", keywords: ["pdf merge", "merge pdf", "combine pdf files", "join pdf", "merge pdf files"], howToUse: ["Upload two or more PDF files, such as reports, scans, forms, or pages from the same project.", "Arrange the files in the order you want, for example cover page first and supporting pages after it.", "Merge them and download the combined PDF, then use PDF Compressor if the final file is larger than you want."], implementationStatus: "working-local", seoTitle: "Free PDF Merge — Combine PDF Files Online Instantly", seoDescription: "Merge multiple PDFs into one in seconds. Drag files to reorder, then download your combined PDF free — no account needed.", faq1: "What is a practical use case for PDF Merge?", faqAnswer1: "A practical use case is combining several related documents into one file before sending or printing them. People often merge resumes and supporting files, invoices for the same month, or scanned pages that belong in one packet.", faq2: "Should I split a file before merging?", faqAnswer2: "If one source PDF contains pages you do not need, splitting first can make the final merged file cleaner. Many people use PDF Split to separate only the needed pages and then merge those selected files into one document." }),
  ...
  makeTool({ name: "Word Counter", slug: "word-counter", category: "text-tools", shortDescription: "Count words in pasted or typed text.", longDescription: "Word Counter is a simple browser-side text utility that fits this project especially well. The page is ready for a local implementation that updates counts in real time as the user types or pastes text.", keywords: ["word counter", "count words online", "text word count"], howToUse: ["Paste or type text.", "Review the live word count.", "Adjust your content as needed."], implementationStatus: "working-local", seoTitle: "Free Word Counter — Count Words & Characters Online", seoDescription: "Count words, characters, sentences, and paragraphs instantly. Paste any text and get your character count free — no signup.", faq1: "Does the count update live?", faqAnswer1: "That is the intended local behavior for this tool.", faq2: "Can I use it for SEO writing?", faqAnswer2: "Yes. Word counting is useful for outlines, article drafts, and content reviews." }),
...
const uniqueToolDrafts = toolDrafts.filter(
  (tool, index, collection) => collection.findIndex((candidate) => candidate.slug === tool.slug) === index,
);
const toolDraftOrder = new Map(uniqueToolDrafts.map((tool, index) => [tool.slug, index]));
...
export const tools: ToolDefinition[] = uniqueToolDrafts.map((tool) => ({
  ...tool,
