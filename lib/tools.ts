...
const toolDraftsPart1: ToolDraft[] = [
  ...
  makeTool({ name: "GIF Maker", slug: "gif-maker", category: "image-tools", shortDescription: "Turn a sequence of images into a shareable GIF animation for free in the browser.", longDescription: "GIF Maker is useful when several images tell a short story better than one still frame. You can turn screenshots, product steps, design progress shots, or simple photo sequences into a looping GIF for messages, tutorials, or social posts. For example, a creator may combine a few progress images into a quick animation, or a seller may show a product from several angles in one looping file. It is an especially appealing free tool because it creates an eye-catching visual format without paid editing software or a video workflow.", keywords: ["gif maker", "make gif from images", "image to gif", "animated gif creator"], howToUse: ["Upload the images you want to animate, such as screenshots, product angles, or step-by-step visuals.", "Choose the frame order and timing so the GIF moves the way you want.", "Export the finished GIF and use it in chats, posts, guides, or simple promotional content."], implementationStatus: "working-local", seoTitle: "GIF Maker Online", seoDescription: "Create GIF animations online from images with a free browser-side workflow for tutorials, posts, and quick visual loops.", faq1: "What kinds of images make a smoother GIF?", faqAnswer1: "Images with similar size, framing, and lighting usually create the smoothest animations, because large jumps between frames can feel abrupt.", faq2: "Should I resize images before making a GIF?", faqAnswer2: "Usually yes. Smaller images often create lighter GIF files that are easier to share on websites, chats, and social platforms." }),
