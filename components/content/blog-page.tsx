    ...
    <div className="site-shell mx-auto max-w-4xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8">
      ...
      <div className="mt-8 space-y-6">
        ...
        <section className="site-card rounded-[2rem] border border-[color:var(--border)] bg-white/88 p-7 shadow-sm sm:p-8">
          <h2 className="site-section-title text-2xl font-black tracking-tight">{article.h1} FAQs</h2>
          <div className="mt-5">
        ...
        <section className="site-card rounded-[2rem] border border-[color:var(--border)] bg-white/88 p-7 shadow-sm sm:p-8">
          <h2 className="site-section-title text-2xl font-black tracking-tight">Related tools</h2>
