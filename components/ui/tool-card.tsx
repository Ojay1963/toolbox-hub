...
import { FavouriteButton } from "@/components/engagement/favourite-button";
    ...
    return (
      <div className="relative">
        <Link
          ...
          prefetch={false}
          className="mobile-compact-tool-card app-panel-muted group block rounded-2xl px-4 py-3 pr-10 transition hover:border-[color:var(--primary)]"
        >
  ...
  return (
    <div className="relative">
      <Link
        href={`/tools/${tool.slug}`}
        prefetch={false}
        className="mobile-tool-card app-panel group block rounded-3xl p-5 pr-12 transition hover:-translate-y-1 hover:border-[color:var(--primary)]/35 hover:shadow-lg"
      >
